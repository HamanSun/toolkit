...
public class Const {
	...
	public static final String FILEPATHFILE = "/member/uploadFiles/file/";					//文件上传路径
	//public static final String FILEPATHFILE = "/export/Logs/member/";					//文件上传路径
	public static final String FILEPATHIMG = "/member/uploadFiles/imgs/";					//图片上传路径
	
	public static final String FILEACTIVITI = "/member/uploadFiles/activitiFile/";			//工作流生成XML和PNG目录
